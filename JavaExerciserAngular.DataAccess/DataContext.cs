    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Exercise>().HasData(
            new Exercise
            {
                ...
                Techniques = new()
                {
                    new(){TechniqueName="int" },
                    new(){TechniqueName="Integer.parseInt()" },
                    new(){TechniqueName="Integer.toBinaryString()" },
                    new(){TechniqueName="operators - arithmetic" },
                    new(){TechniqueName="Scanner" },
                    new(){TechniqueName="Scanner.next()" },
                    new(){TechniqueName="String" }
                },
        ...
        //        new(){TechniqueName=},
        //        new(){TechniqueName=},
        //        "operators - arithmetic", "Scanner", "Scanner.nextInt()", "System.out.print()", "System.out.println()"
        //    },
        ...
        //        new(){TechniqueName=},
        //        new(){TechniqueName=},
        //        "foreach-loops", "List", "List.of()", "Scanner", "Scanner.next()", "String.charAt()", "String.length()", "System.exit()", "System.out.print()", "System.out.printf()"
        //    },
